...
{
  if(figura == 2){
   if(tecla == 'P')//cubo.draw_puntos(1.0,0.5,0.0,3);
      ...
      cubo.draw_solido_ajedrez(1.0,0.5,0.0,0.5,0.0,3);
  }else{
    if(tecla == 'P')//cubo.draw_puntos(1.0,0.5,0.0,3);
       ...
       piramide.draw_solido_ajedrez(1.0,0.5,0.0,0.5,0.0,3);
  }
}
...
void normal_keys(unsigned char Tecla1,int x,int y)
{
  switch (toupper(Tecla1)){
	   case 'Q':exit(0);
	   case 'P':tecla = 'P';break;
     case 'L':tecla = 'L';break;
     case 'F':tecla = 'F';break;
     case 'C':tecla = 'C';break;
